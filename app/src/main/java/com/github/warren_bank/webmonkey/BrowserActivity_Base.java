...
public class BrowserActivity_Base extends WebViewGmImpl implements IBrowser {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    if (item.getItemId() == R.id.menu_update_scripts) {
      ...
      return true;
    } else if (item.getItemId() == R.id.menu_toggle_dark_mode) {
      WebViewSettingsMgr.toggleDarkMode();
      return true;
  ...
  public void onWebProgressChanged(int progress) {
    if (scriptBrowser != null) {
      scriptBrowser.updateProgress(progress);
    }
  }

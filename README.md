...
No-frills light-weight Android web browser with support for Greasemonkey and Tampermonkey userscripts, built for Android with modern Gradle and AGP.

* Built for Android 5.0+ (API 21+) with target SDK 35/36.
* Integrated ad-blocking engine with customizable blocklists.
* Greasemonkey legacy and GM 4 APIs support with polyfills.
